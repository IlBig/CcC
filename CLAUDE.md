...
└── templates/
    ├── AGENT.md.template            # Primary AI instruction file template
    ├── CLAUDE.md.template           # Redirect template ("See AGENT.md")
...
- **AGENT.md is primary** — contains all AI instructions; CLAUDE.md in projects contains only `See AGENT.md`
...
- **Phase C:** Claude Code generates code per `AGENT.md` + `SPEC.md` + `RESEARCH.md`
